...
class RecordButton extends React.Component {
    ...
    componentDidMount() {
        ...
        Audio.setAudioModeAsync({
            ...
            .then((r) => console.log(`Set audio mode ${r}`))
            .catch((e) => console.log(e));
    }
    ...
    componentWillUnmount() {
        ...
        if (this.recording !== null) {
            this.recording
                .stopAndUnloadAsync()
                .then((r) => console.log(`Stop and unload unount ${r}`))
                .catch((e) => console.log(e));
            this.recording = null;
        }
    }
    ...
    render() {
        return this.state.permissionsGranted ? (
            ...
            >
                <Ionicons size={70} name={"mic-circle-outline"} />
            </TouchableOpacity>
        ) : (
            // TODO: UI Make this nicer
            <Title>
                {" "}
                We need microphone permissions for you to be able to record
                messages
            </Title>
        );
    }
