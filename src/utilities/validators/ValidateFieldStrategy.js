...
class ValidateFieldStrategyFactory {
    ...
    create = fieldName => {
        if (fieldName === GLOBAL_VAR.FIELD_NAME.EMAIL) {
            return new ValidateEmail()
        } else if (fieldName === GLOBAL_VAR.FIELD_NAME.PASSWORD) {
            return new ValidatePassword()
        } else if (
            fieldName === GLOBAL_VAR.FIELD_NAME.USERNAME ||
            fieldName === GLOBAL_VAR.FIELD_NAME.FIRSTNAME ||
            fieldName === GLOBAL_VAR.FIELD_NAME.LASTNAME
        ) {
            return new ValidateGeneralTextInput(fieldName)
        }
